...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    initialLocation: onboardingCompleted ? AppRoutes.dashboard : AppRoutes.onboarding,
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            pageBuilder: (context, state) => _fadeTransition(state, const RemindersListPage()),
          ),
          GoRoute(
            path: AppRoutes.settings,
            pageBuilder: (context, state) => _fadeTransition(state, const SettingsPage()),
          ),
        ],
      ),
      GoRoute(
...
class _MainShell extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    int selectedIndex = 0;
    if (location.startsWith('/reminders')) selectedIndex = 1;
